...
VERIFICACION2:
    MOVF CONTADOR, W	; MOVEMOS LOS DATOS DE CONTADOR A W
    ...
    MOVLW 0b0111111	; CARGAMOS UN 0 A W
    MOVWF PORTD		; CARGAMOS EL 0 DE W AL DISPLAY
    CLRF CONTADOR	; LIMPIAMOS EL CONTADOR
    GOTO DISPLAY	; VAMOS A DISPLAY
DISPLAY:
    INCF CONTADOR2, F	; INCREMENTAMOS 1 EL CONTADOR2
    MOVF CONTADOR2, W	; MOVEMOS LO QUE ESTE EN CONTADOR2 A W
    PAGESEL TABLA
    CALL TABLA		; LLAMAMOS A LA TABLA
    MOVWF PORTC		; MOVEMOS LOS DATOS DE W AL PORTD
    GOTO VERIFICACION3	; VAMOS A VERIFICACION3
VERIFICACION3:
    MOVF CONTADOR2, W	; MOVEMOS LOS DATOS DEL CONTADOR2 A W
    ...
    MOVLW 0b00111111	; CARGAMOS UN 0 A W
    MOVWF PORTC		; MOVEMOS LOS DATOS DE W AL SEGUNDO DISPLAY
    CLRF CONTADOR2	; LIMPIAMOS LA VARIABLE DE CONTADOR2
